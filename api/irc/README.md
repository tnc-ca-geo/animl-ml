...
1. your local environment, where you will:
   ...
   1. Download the `.h5` model weights and class list YAML from S3
   2. load the model weights, convert them to a `.pt` file, load them into PyTorch and re-compile to torchscript for CPU
