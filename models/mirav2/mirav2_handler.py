"""Custom TorchServe model handler for MIRAv2 model.
"""
...
# img size of efficientnet-b3 model
# from efficienntnet_params() in
# https://github.com/microsoft/CameraTraps/blob/main/classification/efficientnet/utils.py#L452
IMG_SIZE = 300 #
